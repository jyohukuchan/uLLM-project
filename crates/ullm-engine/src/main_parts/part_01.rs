...
impl PackageModelLoopSmokeRun {
    ...
    fn format_output(
        ...
        let (
            ...
            let sq_fp8_projection_kernel_families = sq_fp8_projection_kernel_families(
                sq_fp8_projection_telemetry,
                sq_fp8_projection_dispatches,
            );
            (

...
READY_ROOT = BASE / "resident-one-case-smoke-profile-ready-v11"
DRY_ROOT = BASE / "resident-one-case-smoke-profile-ready-dry-run-v11"
...
def test_profile_ready_v11_is_sealed_and_pins_final_authorities() -> None:
    ...
    qa = json.loads((READY_ROOT / "qa-attestation.json").read_text())
    ...
    assert hashlib.sha256((READY_ROOT / "ready-binding.json").read_bytes()).hexdigest() == "ef23daf6b8166abc98fa0a72a0eeeae86ab24b5b1747ff0018c4240398ba0c18"
    assert hashlib.sha256((READY_ROOT / "SHA256SUMS").read_bytes()).hexdigest() == "7bb6a891969ef73a3024aec370c8e38a245bb95e21711e0f1b6068cdfabf9217"
...
def test_profile_ready_v11_dry_run_is_process_zero_and_sealed() -> None:
    ...
    assert hashlib.sha256((DRY_ROOT / "launcher-evidence.json").read_bytes()).hexdigest() == "b5a863514207ed7055689a9b26e839254ec5805c67cfb626352904121a0dcd2a"
    assert hashlib.sha256((DRY_ROOT / "SHA256SUMS").read_bytes()).hexdigest() == "5f09fe28a036e0fe476e3c9d2fd1003dd52f775bb77711347feb10647002841b"

...
Status: active; P0, P1-A, P1-B1, and P1-B2 CPU RMS normalization/RoPE/causal GQA/typed trace plus state transaction contract completed; adapter fixtures next
...
P1-B2でQwen3.5/Qwen3 adapterのgraph生成fixtureを追加し、typed graphだけでdense/hybrid stackを表現できるP1 Gateを固定する。AQ4 kernelの変更から先に始めない。
...
Status: P1-A, P1-B1, and P1-B2 CPU RMS normalization/RoPE/causal GQA/typed trace plus the state transaction contract completed; adapter fixtures remain.

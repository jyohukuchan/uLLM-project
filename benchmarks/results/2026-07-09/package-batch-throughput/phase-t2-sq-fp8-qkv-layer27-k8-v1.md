# T2 SQ FP8 qkv layer27 k8 prompt bundle v1
...
- layer23 `k16` 通過boundaryにlayer27 `k8` を追加した。
...
| SQ `layer27 k8` | 17 | 46 | 115 | 60.600922 | 72.557192 | 33.416884 | 5246599168 | `24218,5582,329` | false |
...
| --- | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `len4` | 24218 | 24218 | pass | 8 / 8 | 1 | 0.000000000 | 0.299822331 |
| `case_a` | 4105 | 5582 | fail | 8 / 8 | 2 | 0.001428605 | 0.001428605 |
| `case_b` | 329 | 329 | pass | 8 / 8 | 1 | 0.000000000 | 0.202494144 |

## 判断

- layer27 `k8` は`case_a`でstrict top1を落とした。

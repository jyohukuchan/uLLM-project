# T2 SQ FP8 qkv layer23 v8 recovery prompt bundle v1
...
- layer23 `k16` 通過branchにlayer23 `v8` を追加した。
...
| SQ `layer23 v8` | 17 | 46 | 115 | 59.730593 | 73.144428 | 33.132245 | 5116567552 | `24218,5582,329` | false |
...
| --- | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `len4` | 24218 | 24218 | pass | 7 / 8 | 1 | 0.000000000 | 0.296645642 |
| `case_a` | 4105 | 5582 | fail | 8 / 8 | 2 | 0.000022412 | 0.000022412 |
| `case_b` | 329 | 329 | pass | 8 / 8 | 1 | 0.000000000 | 0.209236145 |

## 判断

- layer23 `v8` は`case_a`でstrict top1を落とした。

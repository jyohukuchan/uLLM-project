...
12. Keep `kup1-layer3-k16-up32` as a passing mixed-scale probe and `kup2-k16-up32` as a failure guard.
13. Isolate layer7 next: test layer7-only `k16/up32` and one-sided fallback/scale alternatives before widening k/up coverage.

...
## main fast-forward guard

統合前のmainはHEAD `3407c0521012d101d45fcff0e03ef9ee0e00ec61` で、次のdirty対象を保持していた。
これらの内容は統合中に戻していない。

- modified tracked files:
  - `crates/ullm-engine/src/bin/ullm-aq4-fidelity-capture.rs` — SHA-256
    `dff27f486d46cf8be954c0bd4e89217acbdc75eab96e252ce1df8d435e422761`
  - `crates/ullm-engine/src/bin/ullm-aq4-p2-full-model.rs` — SHA-256
    `6478b0dfecd9ccfe923a81cd63422e8743f9b472012312d4c1782f57395e8093`
  - `crates/ullm-engine/src/bin/ullm-aq4-p2-path-oracle.rs` — SHA-256
    `2b00cd1601260f806c7c64378374e8d040fa1ad947166270a5f43366afe7384a`
  - `tools/run-aq4-p2-resident-smoke-maintenance.py` — SHA-256
    `6953f90d6678b1abb281cd379a193df24ba4708dc15ecde9f1864822e2bc8b8a`
- untracked directories (file count, deterministic aggregate SHA-256):
  - `benchmarks/results/2026-07-14/qwen35-9b-aq4-production-opt-v0.1/p0/` — 4,
    `145471a2b9ee06680ea8cb484be34921ce119cd8432b459d438a1dbdfd32ea77`
  - `benchmarks/results/2026-07-14/qwen35-9b-aq4-production-opt-v0.1/p1/` — 69,
    `4aec63360188de69a7b3f803985aca69fc7f8e3b7616b14b3f1bd440ffc45adc`
  - `benchmarks/results/2026-07-14/qwen35-9b-aq4-production-opt-v0.1/p2/fidelity-calibration-capture-v0.1/attempts/source-attempt-20260714T164526Z/` — 7,
    `c1fdda5b43fb8b7e64c94b149dba2a9bba6eaa571c4b29c04823e88426391e60`
  - `benchmarks/results/2026-07-14/qwen35-9b-aq4-production-opt-v0.1/p2/fidelity-calibration-capture-v0.1/input/` — 4,
    `d57297b476fdf1d7bff77d3242809fe21b40dff3ffe5531ba910ddf740dc7dd4`

Fast-forward target is the integration branch after this journal update. After the fast-forward,
the same status entries and hashes must be observed on main; any missing, replaced, or modified
dirty target is a stop condition.

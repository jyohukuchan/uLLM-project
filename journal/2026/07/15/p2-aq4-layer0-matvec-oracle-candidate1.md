...
This worktree-local CPU result is reference-only until the formal integrated run is bound: its
report is `/tmp/aq4-layer0-runtime-probe-cpu-20260715/report.json`
(SHA-256 `a7e7e1f678fd28b6ab03b91aea48f05d080524a128fde0c2b4798f8c1d1a9452`), and the
concatenated output is `/tmp/aq4-layer0-runtime-probe-cpu-20260715/output.f32le`
(SHA-256 `6808d30743087f28d43fabf69e06f1632fc7dd9a4c0ab87e4aa11e3b0463ef32`). The formal
integrated runtime-order evidence at `/tmp/aq4-layer0-runtime-probe-cpu-20260715-rmsorder/`
must replace these reference hashes with the actual report SHA beginning `6fedd80b` and output
SHA beginning `9683b8c5` before any promotion decision.
